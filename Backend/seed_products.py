...
products_data = [
    ...
    {
        "name": "Retinol Night Serum", "brand": "Luscent Glow", "price": 1799,
...
async def seed():
    ...
    print(f"Successfully inserted {len(result.inserted_ids)} products into {settings.DATABASE_NAME}.products")
    client.close()
