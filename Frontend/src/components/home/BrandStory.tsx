...
const BrandStory = () => {
  return (
    <section className="relative py-32 lg:py-48 overflow-hidden bg-charcoal">
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        <div className="max-w-3xl">
          ...
          >
            ...
            <h2 className="font-display text-5xl lg:text-8xl font-bold text-white leading-[1.1]">
              The <span className="italic font-light text-gold/80">Alchemy</span> of Radiance
            </h2>
            
            <p className="text-white/80 font-body text-xl lg:text-2xl leading-relaxed font-light">
