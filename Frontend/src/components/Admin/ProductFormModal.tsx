        ...
        >
          ...
          <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-8 md:p-12 space-y-12 custom-scrollbar">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
               <div className="space-y-8">
                  ...
                  <div className="grid grid-cols-2 gap-6">
                     ...
                     <div className="space-y-4">
                        ...
                        >
                           <option value="skincare" className={isDark ? "bg-charcoal text-white" : "bg-white text-charcoal"}>Skincare</option>
                           <option value="makeup" className={isDark ? "bg-charcoal text-white" : "bg-white text-charcoal"}>Makeup</option>
                           <option value="bath-body" className={isDark ? "bg-charcoal text-white" : "bg-white text-charcoal"}>Bath & Body</option>
                           <option value="wellness" className={isDark ? "bg-charcoal text-white" : "bg-white text-charcoal"}>Wellness</option>
                        </select>
                     </div>
                  </div>
               </div>
               ...
               <div className="space-y-8">
                  <div className="space-y-4">
                     <label className="text-xs font-bold text-gold uppercase tracking-[0.3em] ml-2">Ritual Visual (URL)</label>
                     <div className="relative">
                        <ImageIcon className={`absolute left-6 top-1/2 -translate-y-1/2 transition-colors ${
                        ...
                        <input 
                          ...
                          required
                           ...
                           className={`w-full border rounded-2xl py-4 pl-16 pr-6 font-body text-sm ${
                             isDark ? "bg-white/5 border-white/10 text-white placeholder:text-white/20" : "bg-charcoal/5 border-charcoal/10 text-charcoal placeholder:text-charcoal/40"
                           }`}
                        />
                     </div>
                  </div>
