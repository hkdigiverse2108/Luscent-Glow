...
export const SANCTUARY_THEMES: SanctuaryTheme[] = [
  {
    ...
    vars: {
      ...
      "--adm-text":         "rgba(255,255,255,0.95)",
      "--adm-text-muted":   "rgba(255,255,255,0.75)",
      "--adm-text-dim":     "rgba(255,255,255,0.55)",
  ...
  },
  {
    ...
    vars: {
      ...
      "--adm-text":         "rgba(28,22,16,0.98)",
      "--adm-text-muted":   "rgba(28,22,16,0.80)",
      "--adm-text-dim":     "rgba(28,22,16,0.60)",
